...
public class SignupThree extends JFrame implements ActionListener {
    ...
    this.formno=formno;
        ...
        add(card);
         ...
         JLabel number = new JLabel("XXXX-XXXX-XXXX-5102");
        ...
        //craete frame
        setSize(850, 1000);   //frame size
        setVisible(true);    // to make frame visible
        setLocation(350, 0);   // to open frame in middle
     }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(ae.getSource() == submit){
            ...
            String cardnumber= ""  + Math.abs( (random.nextLong() % 90000000L) + 238093700000000L);
