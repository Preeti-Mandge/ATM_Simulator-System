...
public class Transactions extends JFrame implements ActionListener {
    ...
    Transactions(String pinnumber) {
        ...
        deposit.setBounds(170, 260, 150, 30);
        deposit.addActionListener(this);
        image.add(deposit);

        withdrawl = new JButton("Cash Withdraw");
        withdrawl.setBounds(360, 260, 150, 30);
        ...
        ministatement.setBounds(360, 300, 150, 30);
        ministatement.addActionListener(this);
        image.add(ministatement);

        pinchange = new JButton("Pin Change");
        pinchange.setBounds(170, 340, 150, 30);
        pinchange.addActionListener(this);
        image.add(pinchange);

        balanceenquiry = new JButton("Balance Enquiry");
        balanceenquiry.setBounds(360, 340, 150, 30);
        balanceenquiry.addActionListener(this);
        image.add(balanceenquiry);

        exit = new JButton("Exit");
        exit.setBounds(360, 380, 150, 30);
